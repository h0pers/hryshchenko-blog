"""
Base Django settings - shared configuration across all environments.
"""

from website.settings import BASE_DIR, env
...
STATIC_ROOT = env.str("DJANGO_STATIC_ROOT", default=None)
